#!/usr/bin/env python3
"""Draw the custom-box design diagrams (docs/research/custom-box.md): python scripts/make_box_diagrams.py

Same drawing kit and style as scripts/make_diagrams.py.
"""
